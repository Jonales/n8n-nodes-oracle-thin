...
export class OracleFactory {
  ...
  /**
   * Validar se um tipo de node é suportado
   */
  static isNodeTypeSupported(nodeName: string): boolean {
    const supportedTypes = [
      'oracleDatabase',
      'oracleDatabaseParameterized', 
      'oracleDatabaseAdvanced',
      'oracleVectorStore',
      'chatMemory'
    ];
    return supportedTypes.includes(nodeName);
  }

  /**
   * Listar todos os tipos de nodes suportados
   */
